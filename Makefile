...
# Frontend codegen lands in secret-fe-lib/lib/ — everything outside lib/ is
# hand-authored and must not be wiped by this target.
BASE_API_FE_DIR := ../secret-fe-lib/lib
